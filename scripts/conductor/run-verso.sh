...
unset VERSO_BUNDLED_PYTHON_DIR VERSO_BUNDLED_SITE_PACKAGES_DIR \
      ...
      VERSO_BACKEND_URL VERSO_HERMES_HOME \
...
if [ "${VERSO_RUN_PROFILE}" = "managed" ]; then
    # Product development uses the deployed managed backend.
